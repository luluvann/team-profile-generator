...
function generateCard(employee){
        ...
        let newEmployee = new Classes.Employee(employee.name, employee.ID, employee.email)
        ...
        <div class="card">
                ...
                <div class="cardBody">
                    ...
                    ${employee.type === "Manager" ? newManager.getOfficeNumber():""}
                    ${employee.type === "Engineer" ?newEngineer.getGithub() : ""}
